...
def register():
    ...
    new_user = User(username=data['username'],first_name=data['first_name'], last_name=data['last_name'], password=hashed_password, email=data['email'], phone=data['phone'])
...
def get_user(username):
    ...
    user_data = {'id': userData.id, 'username': userData.username, 'firstName': userData.first_name, 'lastName': userData.last_name,
